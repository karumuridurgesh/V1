...
{
    class ManualAdjustmentDAL
    {
        IDBOracleAdapter da = new IDBOracleAdapter();

        internal DataSet Open_ABWMADJT()
        {
            ...
            try
            {
                ...
                if (ConfigurationManager.AppSettings["DataB"] == "SQL")
                {
                    ...
                    string spCall = Helper.Ins.GetSPCall(dbManager.Parameters, "Open_ABWMADJT");
                    ds = dbManager.ExecuteDataSet(CommandType.StoredProcedure, "Open_ABWMADJT");
        ...
        internal DataSet Save_ABWMADJT(string strMode, string xmlData)
        {
            IDBManager dbManager = CommonConnection.Connectionstring();
            try
            {
                ...
                string spCall = Helper.Ins.GetSPCall(dbManager.Parameters, "Save_ABWMADJT");
                ds = dbManager.ExecuteDataSet(CommandType.StoredProcedure, "Save_ABWMADJT");
        ...
        internal DataSet Fetch_ABWMADJT(string sMode, string sinputxml,string LocationId,string FileNo)
        {
            IDBManager dbManager = CommonConnection.Connectionstring();
            try
            {
                ...
                if (ConfigurationManager.AppSettings["DataB"] == "SQL")
                {
                    ...
                    dbManager.AddParameters(8, "@FileNo", FileNo, ParameterDirection.Input);

                    string spCall = Helper.Ins.GetSPCall(dbManager.Parameters, "Fetch_ABWMADJT");
                    ds = dbManager.ExecuteDataSet(CommandType.StoredProcedure, "Fetch_ABWMADJT");
        ...
        internal DataSet MADJAction(string sMode, string sVal)
        {
            IDBManager dbManager = CommonConnection.Connectionstring();
            ...
            try
            {
                ...
                if (ConfigurationManager.AppSettings["DataB"] == "SQL")
                {
                    ...
                    string spCall = Helper.Ins.GetSPCall(dbManager.Parameters, "MADJAction");
                    ds = dbManager.ExecuteDataSet(CommandType.StoredProcedure, "MADJAction");
                }
                return ds;
            }
            catch (Exception ex)
        ...
        internal DataSet Fetch_FIFOADJ(string sMode, string sinputxml, string LocationId)
        {
            IDBManager dbManager = CommonConnection.Connectionstring();
            try
            {
                ...
                if (ConfigurationManager.AppSettings["DataB"] == "SQL")
                {
                    ...
                    string spCall = Helper.Ins.GetSPCall(dbManager.Parameters, "Fetch_FIFOADJ");
                    ds = dbManager.ExecuteDataSet(CommandType.StoredProcedure, "Fetch_FIFOADJ");
